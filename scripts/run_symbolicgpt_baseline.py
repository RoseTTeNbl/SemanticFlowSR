#!/usr/bin/env python
"""Run the local small-trained SymbolicGPT baseline adapter."""
...
def main() -> None:
    ...
    ap.add_argument("--tag", default="symbolicgpt_small")
    ap.add_argument("--seed", type=int, default=0)
    ap.add_argument("--max_tasks", "--max-tasks", type=int, default=None)
    ap.add_argument("--repo_root", default="external/symbolicgpt")
    ...
    ap.add_argument("--artifact", default="results/clean_benchmark_20260701/paper_complete_20260702/trained_small_models/symbolicgpt_small_library.json")
    ap.add_argument("--candidate_limit", type=int, default=384)
    ap.add_argument("--prefilter_limit", type=int, default=1600)
    ap.add_argument("--eval_subset", type=int, default=48)
    ...
    results = run_baseline_records(
        ...
        method="SymGPT-small",
        budget={
            "adapter": "small_trained_symbolicgpt",
