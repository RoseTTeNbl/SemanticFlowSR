#!/usr/bin/env python
"""Run the local small-trained NGGP-style baseline adapter."""
...
def main() -> None:
    ...
    ap.add_argument("--tag", default="nggp_small")
    ap.add_argument("--seed", type=int, default=0)
    ap.add_argument("--max_tasks", "--max-tasks", type=int, default=None)
    ap.add_argument("--repo_root", default="external/deep-symbolic-optimization-pytorch")
    ...
    ap.add_argument("--artifact", default="results/clean_benchmark_20260701/paper_complete_20260702/trained_small_models/nggp_small_library.json")
    ap.add_argument("--candidate_limit", type=int, default=640)
    ap.add_argument("--prefilter_limit", type=int, default=2200)
    ...
    results = run_baseline_records(
        ...
        method="NGGP-small",
        budget={
            "adapter": "small_trained_nggp_seeded_search",
